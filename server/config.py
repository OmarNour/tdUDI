...
GRANT SELECT ON {PREFIX}T_SRCI TO {PREFIX}P_PP WITH GRANT OPTION;
GRANT SELECT ON {PREFIX}V_SRCI TO {PREFIX}P_PP WITH GRANT OPTION;
GRANT CREATE TABLE ON {PREFIX}T_SRCI TO {PREFIX}P_PP WITH GRANT OPTION;
GRANT DROP TABLE ON {PREFIX}T_SRCI TO {PREFIX}P_PP WITH GRANT OPTION;
...
GRANT SELECT ON {PREFIX}T_UTLFW TO {PREFIX}P_PP WITH GRANT OPTION;
GRANT INSERT ON {PREFIX}T_UTLFW TO {PREFIX}P_PP WITH GRANT OPTION;
GRANT SELECT ON {PREFIX}T_BASE TO {PREFIX}P_PP WITH GRANT OPTION;
GRANT DELETE ON {PREFIX}T_BASE TO {PREFIX}P_PP WITH GRANT OPTION;
GRANT UPDATE ON {PREFIX}T_BASE TO {PREFIX}P_PP WITH GRANT OPTION;
GRANT INSERT ON {PREFIX}T_BASE TO {PREFIX}P_PP WITH GRANT OPTION;
GRANT SELECT ON {PREFIX}V_BASE TO {PREFIX}P_PP WITH GRANT OPTION;
GRANT SELECT ON {PREFIX}V_STG_ONLINE TO {PREFIX}P_PP WITH GRANT OPTION;
GRANT SELECT ON {PREFIX}T_STG TO {PREFIX}P_PP WITH GRANT OPTION;
GRANT DELETE ON {PREFIX}T_STG TO {PREFIX}P_PP WITH GRANT OPTION;
GRANT UPDATE ON {PREFIX}T_STG TO {PREFIX}P_PP WITH GRANT OPTION;
GRANT INSERT ON {PREFIX}T_STG TO {PREFIX}P_PP WITH GRANT OPTION;
