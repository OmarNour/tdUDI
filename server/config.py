...
INSERT INTO {meta_db}.CORE_TABLES_LKP (TABLE_NAME, IS_LOOKUP, IS_HISTORY,START_DATE_COLUMN ,END_DATE_COLUMN, ACTIVE)
VALUES ({TABLE_NAME}, {IS_LOOKUP}, {IS_HISTORY},{START_DATE_COLUMN} ,{END_DATE_COLUMN}, 1);
"""
INSERT_INTO_TRANSFORM_KEYCOL = """
INSERT INTO {meta_db}.GCFR_Transform_KeyCol (DB_NAME, TABLE_NAME, KEY_COLUMN)
